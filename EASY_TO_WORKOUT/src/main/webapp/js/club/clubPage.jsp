	...
	<div class="container">
		...
		<div style="width: 400px; height: 600px; border: 1px solid; float: left; margin-right: 10px;">
			...
			<div style="height: 50px;">
				<!-- 모임 개설 버튼 -->
				<input id="createButton" type="button" value="모임 개설" onclick="location.href='./club_openForm.jsp'">
			</div>
		</div>
				...
				<div style="width: 670px; height: 30px;">
					<table id="listTable">
						...
						<tr id="listTr">
							...
							<td>(10/20)</td>
							<td>
								<input id="etcButton" type='BUTTON' value="더보기" onclick="location.href='./club_detail.jsp'">
